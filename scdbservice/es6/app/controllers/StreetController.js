...
class StreetController {
    ...
    findById(req, res) {
        ...
        this.streetDao.findById(id)
            .then(this.common.findSuccess(res))
            .catch(this.common.findError(res));
    }
    findAll(req,res) {
        this.streetDao.findAll()
            .then(this.common.findSuccess(res))
            .catch(this.common.findError(res));
    }
    query(req,res) { 
        ...
        if(legalid)
        {
            this.streetDao.findByLegalId(legalid)
            .then(rows=>{
                if(rows.length >0)
                {
        ...
        else
        {
            ...
            this.streetDao.findByPaging(pageNum,pageCount)
                .then(this.common.findSuccess(res))
                .catch(this.common.findError(res));
        }
    ...
    nearst(req,res) {
        ...
        {
            this.streetDao.findByNearst(x,y,n)
            .then(this.common.findSuccess(res))
            .catch(this.common.findError(res));
        }
    }
