'use strict';
class NtDCDB {
    constructor(ogc_fid,longitude,latitude,create_date  ,tenure_folio  ,street_name  ,ilis_link  ,parcel_type  ,ucv_per_m2  ,
        part  ,unit_count  ,ucv_date  ,owner_category  ,tenure_reference_description  ,parcel_area_m2  ,
        location_name  , street_number  ,laiskey  ,tenure_status  ,street_number_part  ,location_code  ,
        tenure_reference_type  ,survey_plan_link  ,street_number_prefix  ,lto_code  ,tenure_reference_number  ,
        parcel  ,town_planning_zone  ,status_code  ,date_extracted  ,suburb  ,tenure_volume_type  ,property_name  ,
        ufi  ,parcel_label  ,survey_plan_number  ,admin_norm  , tenure_volume  ,
        pfi  ,street_type  ,   survey_id  ,ucv_amount ) {
