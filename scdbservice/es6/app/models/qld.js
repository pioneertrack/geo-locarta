'use strict';
class Qld {
    constructor(ogc_fid, geometry, objectid,mrk_id,alt1_nm,alt2_nm,alt3_nm,alt4_nm,
        town_nm, mossman, lclauth_nm, locality_d, relinfo_de,
        mrktype_de, install_nm, install_dt, mrkcnd_de, lastvisit_, form6_fg, cadcon_ct, 
        srvplan1_i, srvplan1_d, srvplan2_i, srvplan2_d, srvplan3_i, srvplan3_d,  srvplan4_i, srvplan4_d, 
        srvplan5_i, srvplan5_d,gdalineage,
        gdalatitud,gdalongitu,gdahrzposu,gdacls_de,gdaacc_de,gdaheight,gdavrtposu,gdaadj_nm,gdafix_de,ahdlineage,
        ahdheight,ahdposu,ahdcls_de,ahdacc_de,ahdfix_de,ahdnlnsect,ahdoriginm,gdaadj_dt,ahdadj_dt,ahdphysica,
        ahdgeospho,ahdgsdat_d,ahdmodel_d,icon_id,easting , northing,zone,longitude,latitude,mb_id ) {
        ...
        this.ahdphysica=ahdphysica,
        this.ahdgeospho=ahdgeospho,
        this.ahdgsdat_d= ahdgsdat_d,
        this.ahdmodel_d= ahdmodel_d,
