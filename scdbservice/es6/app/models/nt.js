'use strict';
class Nt {
    constructor(ogc_fid, geometry, objectid,horizuncertainty,marktype,surveyplan,horizsurveymethod,
        officalfile, verticaldatum, quasi_ahd, surveyplan_link, fieldbook,
        adjstatus, location, extract_date, class_, geoiddeviation, verticalsurveymethod, adj_rl, 
        vertuncertainty, verticalorder, diagram_link, mga_north, horizontaldatum, dec_long,dec_lat,verticalclass,
       description,zone,note1,note3,reg13certificate,note5,note7,note6,mga_east,primaryname,note2,note4,horizprojection,mb_id) {
