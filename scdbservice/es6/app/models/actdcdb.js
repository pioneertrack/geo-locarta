'use strict';
class ActDCDB {
    constructor(ogc_fid   ,longitude,latitude,objectid,block_derived_area,block_leased_area  ,block_key  ,block_number  ,
	section_number  ,current_lifecycle_stage  ,addresses  ,plan_numbers  ,volume_folio  ,
	land_use_policy_zones  ,overlay_provision_zones  ,water_flag  ,stratum_datum_id  ,
	ground_level  ,stratum_lowest_level  ,stratum_highest_level  ,division_code  ,division_name  ,
	district_code  ,district_name  ,cuc  ,tp_written_statement  ,url  ,type  ,last_update) {
