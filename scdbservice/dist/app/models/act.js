...
class Act {
    constructor(ogc_fid, geometry, objectid, type, name, construction, condition, lifecycle_stage, datum, easting, northing, hz_class, hz_order, rl_datum, reduced_level, ht_class, ht_order, mar_id, id, remarks, plans, hz_palm_order, ht_palm_order, district_name, division_name) {
