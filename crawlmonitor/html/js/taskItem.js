$(document).ready( function() {
                    ...
                    var waTable = $('#taskItemList').WATable({
                ...
                if(token)
                {
                    ...
                    $.ajax({
                        url: "api/taskItem/queryByTaskId/"+taskId,
            ...
            function generateRowData(data) {
                ...
                var cols = {
                    taskId: {
                        ...
                        format: "",  //Used to format the data anything you want. Use {0} as placeholder for the actual data.
